...
# Auto-extract
Sig.Bayesian.prob = sig_auto_extract(CNV.prob$nmf_matrix, result_prefix = "BayesNMF_Prob.Seqz", nrun = 100,
                                     destdir = "output/signature", cores = 16)
Sig.Bayesian.count = sig_auto_extract(CNV.count$nmf_matrix, result_prefix = "BayesNMF_Count.Seqz", nrun = 100,
                                      destdir = "output/signature", cores = 16)
