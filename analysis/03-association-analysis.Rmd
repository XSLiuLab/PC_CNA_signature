...
Next, we process mutation data to get TMB, driver info, clusters, and etc (the detail has been described in [R script](https://github.com/ShixiangWang/prad_signature/blob/master/analysis/src/03-data-integration-updates.R) of the repo).
...
```{r}
colnames(df.seqz)[c(23:26)] = c("TD score", "sTD score", "lTD score", "Chromothripisis score")
...
~~[click here to see the plot](corrr_network.pdf)~~
