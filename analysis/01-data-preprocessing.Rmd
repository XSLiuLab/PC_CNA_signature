...
#### 8.1 call somatic short variants and indel
...
#### 8.2 estimate cross-sample contamination using GetPileupSummaries and CalculateContamination.
...
#### 8.3 get tumor artifacts using LearnReadOrientationModel.
...
#### 8.4 filter for confident somatic calls using FilterMutectCalls.
