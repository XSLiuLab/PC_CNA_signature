...
we used the same reference genome (downlowned from [GDC portal](https://portal.gdc.cancer.gov/)) and operations (see [GDC docs](https://docs.gdc.cancer.gov/Data/Bioinformatics_Pipelines/DNA_Seq_Variant_Calling_Pipeline/)).
