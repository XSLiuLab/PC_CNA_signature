...
CNV_rmX <- read_copynumber(CNV_rmX,
  genome_build = "hg38",
  complement = FALSE, verbose = TRUE
)
...
# Auto-extract
Sig.Bayesian.rmX.prob <- sig_auto_extract(CNV_rmX.prob$nmf_matrix,
  result_prefix = "BayesNMF_rmX_Prob", nrun = 100,
  destdir = "output/signature", cores = 16
)
Sig.Bayesian.rmX.count <- sig_auto_extract(CNV_rmX.count$nmf_matrix,
  result_prefix = "BayesNMF_rmX_Count", nrun = 100,
  destdir = "output/signature", cores = 16
)
