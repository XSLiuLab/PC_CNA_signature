...
CNV_seqz = read_copynumber(CNV_seqz, genome_build = "hg38",
                      complement = FALSE, verbose = TRUE)

CNV_facets = read_copynumber(CNV_facets, genome_build = "hg38",
                           complement = FALSE, verbose = TRUE)
...
save(CNV.seqz.pre, CNV.facets.pre, seqz.est, seqz.est.50, facets.est,
     sigs.seqz, sigs.seqz_50_5, sigs.seqz_50_7, file = "test.RData")
